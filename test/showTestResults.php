...
<div class="container">
    ...
    <?php foreach ($results['image'] as $imageQuestion):
        ...
        <table class="table border text-center">
            <tr class="text-left">
                <th colspan="3" class="pl-5"><span
                            class="pr-2">Otázka:</span><?= $imageQuestion['question'] ?> <?php echo $text; ?></th>
            </tr>
            <tr>
                <th>Tvoja odpoveď</th>
                <th>Body</th>
    ...
    <?php foreach ($results['expression'] as $expressionQuestion):
        ...
        <table class="table border text-center">
            <tr class="text-left">
                <th colspan="3" class="pl-5"><span
                            class="pr-2">Otázka:</span><?= $expressionQuestion['question'] ?> <?php echo $text; ?></th>
            </tr>
            <tr>
                <th>Tvoja odpoveď</th>
                <th>Body</th>
            ...
            <tr <?php echo $background; ?>>
                ...
                <td class="w-33"><?= $expressionQuestion['points'] ?: '-' ?>
                    / <?= $expressionQuestion['max_points'] ?></td>
            </tr>
        </table>
