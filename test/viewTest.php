    ...
    ?>
            ...
            ?>
                <div class="form-group">
                    ...
                    <!--                    <label class="font-weight-bold" for="question--><? //=$question['id']
                                                                                            ?>
                    <!--">--><? //=$question['question']
                                ?>
                    <!--<span class="pl-2">[--><? //=$question['max_points']
                                                ?>
                    <!--b]</span></label>-->
                    <!--                    <input type="text" class="form-control" id="question--><? //=$question['id']
                                                                                                    ?>
                    <!--" name="answers[simple][--><? //=$question['id']
                                                    ?>
                    <!--]" placeholder="Answer">-->
            ...
            ?>
                ...
                <div class="form-group">
                    <label class="font-weight-bold" for="question<?= $question['id'] ?>"><?= $question['question'] ?><span class="pl-2">[<?= $question['max_points'] ?>b]</span></label>
                    <textarea type="text" class="ckeditor" id="question<?= $question['id'] ?>" name="answers[expression][<?= $question['id'] ?>]"></textarea>
                </div>  
            <?php break;   
        }
    } ?>
