    ...
    <form action="../router.php" method="post">
        <?php foreach ($results['simple'] as $simpleQuestion) : ?>
            ...
            <div class="table-overflow">
                <table class="table border text-center">
                    <tr class="text-left">
                        <th colspan="4" class="pl-5"><span class="pr-2">Otázka:</span><?= $simpleQuestion['question'] ?>
                        </th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="row">
                                <input disabled type="number" step="0.1" min="0"
                                       max="<?= $simpleQuestion['max_points'] ?>" class="col-8 text-center"
                                       aria-label="Answer points"
                                       name="modifications[notPair][<?= $simpleQuestion['answer_id'] ?>]"
                                       value="<?= $simpleQuestion['points'] ?>">
        ...
        <?php foreach ($results['option'] as $optionQuestion) : ?>
            ...
            <div class="table-overflow">
                <table class="table border text-center">
                    <tr class="text-left">
                        <th colspan="3" class="pl-5"><span class="pr-2">Otázka:</span><?= $optionQuestion['question'] ?>
                        </th>
                    </tr>
                    <tr>
                        <th class="w-30">Študentova odpoveď</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="row">
                                <input disabled type="number" step="0.1" min="0"
                                       max="<?= $optionQuestion['max_points'] ?>"
                                       class="col-8 text-center" aria-label="Answer points"
                                       name="modifications[notPair][<?= $optionQuestion['answer_id'] ?>]"
                                       value="<?= $optionQuestion['points'] ?>">
        ...
        <?php foreach ($results['pair'] as $pairQuestion) : ?>
            ...
            <div class="table-overflow">
                <table class="table border text-center">
                    <tr class="text-left">
                        <th colspan="4" class="pl-5"><span class="pr-2">Otázka:</span><?= $pairQuestion['question'] ?>
                        </th>
                    </tr>
                    <tr>
                    ...
                    <?php foreach (json_decode($pairQuestion['pairs'], true) as $pair) : ?>
                        <tr>
                            ...
                            <td>
                                <div class="row">
                                    <input disabled type="number" step="0.1" min="0" max="<?= $pair['max_points'] ?>"
                                           class="col-8 text-center" aria-label="Answer points"
                                           name="modifications[pair][<?= $pair['answer_id'] ?>][<?= $pair['answer_pair_id'] ?>]"
                                           value="<?= $pair['points'] ?>">
        ...
        <?php foreach ($results['image'] as $imageQuestion) : ?>
            ...
            <div class="table-overflow">
                <table class="table border text-center">
                    <tr class="text-left">
                        <th colspan="3" class="pl-5"><span class="pr-2">Otázka:</span><?= $imageQuestion['question'] ?>
                        </th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <button type="button" class="btn btn-success px-5"
                                    onclick="toggleModal('<?= $imageQuestion['image_url'] ?>')">Obrázok
                            </button>
                        </td>
                        <td>
                            <div class="row">
                                <input class="col-8 text-center<?= ($imageQuestion['points'] ? '" disabled value="' . $imageQuestion['points'] : ' border-danger') ?>"
                                       type="number" step="0.1" min="0" max="<?= $imageQuestion['max_points'] ?>"
                                       aria-label="Answer points"
                                       name="modifications[notPair][<?= $imageQuestion['answer_id'] ?>]">
        ...
        <?php foreach ($results['expression'] as $expressionQuestion) : ?>
            ...
            <div class="table-overflow">
                <table class="table border text-center">
                    <tr class="text-left">
                        <th colspan="4" class="pl-5"><span class="pr-2">Q:</span><?= $expressionQuestion['question'] ?>
                        </th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="row">
                                <input class="col-8 text-center<?= ($expressionQuestion['points'] ? '" disabled value="' . $expressionQuestion['points'] : ' border-danger') ?>"
                                       type="number" step="0.1" min="0" max="<?= $expressionQuestion['max_points'] ?>"
                                       aria-label="Answer points"
                                       name="modifications[notPair][<?= $expressionQuestion['answer_id'] ?>]">
